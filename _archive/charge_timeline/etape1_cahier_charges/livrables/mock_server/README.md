...
```bash
cd "c:/Users/achim/Desktop/Espace de travail/LIA/charge_timeline/etape1_cahier_charges/livrables/mock_server"
python -m venv .venv
...
Le serveur lit directement `../api_spec_openapi.yaml`, toute mise à jour sera visible sans changer le code.
